...
public class TorneoCommand implements CommandExecutor, TabCompleter {
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        if (args.length == 1) {
            ...
            List<String> options = Arrays.asList("add", "delete", "finishAdd", "finishDelete", "list", "off", "on", "help");
    ...
    private void listTournamentCommands(Player player) {
        ...
        player.sendMessage(ChatColor.translateAlternateColorCodes('&', 
                plugin.getMessagesConfig().getString("messages.tournament_list_finish_commands")));
